# Generated by Django 4.2.6 on 2023-11-11 12:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='timings', to='monitor.store')),
            ],
        ),
        migrations.CreateModel(
            name='StoreStatusLog',
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_logs', to='monitor.store')),
            ],
        ),
        migrations.CreateModel(
            name='StoreReport',
            fields=[
                ...
                ('store', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reports', to='monitor.store')),
            ],
        ),
    ]
